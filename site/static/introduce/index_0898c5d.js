$(function(){
        ...
        afterRender:function(){
                /*$('.s1pic1').fadeIn(300).animate({'margin-top':'300px'},500);
                $('.p1s2').delay(200).animate({'margin-top':'30px'},500);
                $('.p1s3').delay(200).fadeIn(700);
                $('.upArrow').delay(500).fadeIn(700);
                $('.downArrow').delay(500).fadeIn(700);
                $('.qr-code').addClass('qrshrink');*/
                $('.s1pic1').addClass('fadeInDown');
        },
        afterLoad: function(anchorLink, index){
            if(index == 1){
                /*$('.page1').show();
                $('.s1pic1').animate({'margin-top':'300px'},500);
                $('.p1s2').delay(200).animate({'margin-top':'30px'},500);
                $('.p1s3').delay(200).fadeIn(700);
                $('.upArrow').delay(200).fadeIn(700);
                $('.downArrow').delay(200).fadeIn(700);
                $('.qr-code').addClass('qrshrink');*/
            }
            if(index == 2){
        ...
        onLeave: function(index, direction){
            if(index == 1){
                $('.s1pic1').animate({'margin-top':'-300px'},1);
                $('.p1s2').delay(200).animate({'margin-top':'-330px'},1);
                $('.p1s3').hide();
