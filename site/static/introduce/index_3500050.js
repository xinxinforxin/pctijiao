$(function(){
        ...
        afterLoad: function(anchorLink, index){
            if(index == 1){
                $('#s1pic1').removeClass().addClass('fadeInDown');
                $('.p1s2').removeClass('fadeOut').addClass('fadeIn');
        ...
        onLeave: function(index, direction){
            if(index == 1){
                ...
                $('.p1s2').removeClass('fadeIn animated inifinite').addClass('fadeOut animated inifinite');
            }
            if(index == 2){
                $('.s2block1').hide(0);
