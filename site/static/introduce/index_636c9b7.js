$(function(){
        ...
        afterRender:function(){
           ...
           $('.p1s2').addClass('fadeIn animated inifinite');
        },
        afterLoad: function(anchorLink, index){
            if(index == 1){
                $('#s1pic1').removeClass().addClass('fadeInDown animated inifinite');
                $('.p1s2').removeClass('fadeIn animated inifinite').addClass('fadeIn animated inifinite');
        ...
        onLeave: function(index, direction){
            if(index == 1){
                ...
                $('.p1s2').removeClass('fadeOut animated inifinite').addClass('fadeOut animated inifinite');
            }
            if(index == 2){
                $('.s2block1').hide(0);
