$(function(){
        ...
        afterRender:function(){
            $('.s3font:nth-child(1)').removeClass().addClass('fadeInLeft animated inifinite');
                $('.s3font:nth-child(2)').removeClass().addClass('fadeInRight animated inifinite');
                $('.s3font:nth-child(3)').removeClass().addClass('fadeInLeft animated inifinite');
                $('.s3font:nth-child(4)').removeClass().addClass('fadeInRight animated inifinite');
        ...
        afterLoad: function(anchorLink, index){
            ...
            if(index == 3){
                ...
                $('.s3font h5:nth-child(1)').removeClass().addClass('fadeInLeft animated inifinite');
                $('.s3font h5:nth-child(2)').removeClass().addClass('fadeInRight animated inifinite');
