$(function(){
        ...
        afterLoad: function(anchorLink, index){
            ...
            if(index == 3){
                $('.s3font:first').removeClass().addClass('fadeInLeft animated inifinite');
                $('.s3font').get(1).removeClass().addClass('fadeInLeft animated inifinite');
                $('.s3font').get(2).removeClass().addClass('fadeInLeft animated inifinite');
                $('.s3font').get(3).removeClass().addClass('fadeInLeft animated inifinite');
