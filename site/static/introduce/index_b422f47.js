$(function(){
        ...
        afterRender:function(){
               /* $('.s1pic1').animate({'margin-top':'0px'},500);
                $('#s1font1').delay(200).animate({'margin-top':'0px'},500);
                $('.p1-2').delay(200).fadeIn(700);
        ...
        onLeave: function(index, direction){
            if(index == 1){
                $('.s1pic1').animate({'margin-top':'-500px'},1);
                $('#s1font1').animate({'margin-top':'-500px'},1);
                $('.p1-2').hide();
