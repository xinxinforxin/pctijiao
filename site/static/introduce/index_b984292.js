$(function(){
        ...
        afterRender:function(){
            $('#s1pic1').removeClass().addClass('fadeInDown animated inifinite');
            $('.animate-block').addClass('fadeIn animated');
            $('.qr-code').addClass('qrshrink');
        },
        afterLoad: function(anchorLink, index){
            if(index == 1){
                $('#s1pic1').removeClass().addClass('fadeInDown animated inifinite');
                $('.animate-block').removeClass('fadeOut').addClass('fadeIn');
                $('.qr-code').addClass('qrshrink');
            }
            if(index == 2){
                $('#s2block1').removeClass().addClass('fadeInDown animated inifinite');
                $('#s2block2').removeClass().addClass('fadeInUp animated inifinite');
                $('#s2block2-1').removeClass().addClass('fadeInUp animated inifinite');
                $('.qr-code').addClass('qrshrink');
            }
            if(index == 3){
                $('.s3font h1:nth-child(1)').removeClass().addClass('fadeInLeft animated inifinite');
                $('.s3font h1:nth-child(2)').removeClass().addClass('fadeInRight animated inifinite');
                $('.grayFont').eq(0).removeClass('fadeInLeft animated inifinite').addClass('fadeInLeft animated inifinite');
                $('.grayFont').eq(1).removeClass('fadeInRight animated inifinite').addClass('fadeInRight animated inifinite');
            ...
            if(index == 4){
                $('.s4fonts').show();
                $('.s4fonts>p').animate({width: '500px'}, 3000);
                $('#unionI').fadeIn(700);
                $('.tpeople').fadeIn(0);
            ...
            if(index == 5){
            $('.p5').fadeIn(50);
            $('.s5fontBlock1').show(100);
            $('#drawLine').show(500);
            $('.s5fontBlock2').show(100);
        ...
        onLeave: function(index, direction){
            if(index == 1){
                $('#s1pic1').removeClass().addClass('fadeOutDown animated inifinite');
                $('.animate-block').removeClass('fadeIn').addClass('fadeOut');
            }
            if(index == 2){
                $('#s2block1').removeClass().addClass('fadeOut');
                $('#s2block2').removeClass().addClass('fadeOut');
                $('#s2block2-1').removeClass().addClass('fadeOut');
                $('.qr-code').removeClass('qrshrink');
            }
            if(index == 3){
                $('.s3font h1:nth-child(1)').removeClass().addClass('fadeOut');
                $('.s3font h1:nth-child(2)').removeClass().addClass('fadeOut');
                $('.grayFont').eq(0).removeClass('fadeInLeft animated inifinite').addClass('fadeOut');
                $('.grayFont').eq(1).removeClass('fadeInRight animated inifinite').addClass('fadeOut');
                $('.s3pics1').hide();
                $('.s3pics2').hide();
