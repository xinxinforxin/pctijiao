$(function(){
        ...
        afterRender:function(){
           ...
           $('.p1s2,.p1s3,upArrow,downArrow').addClass('fadeIn animated');
           $('.qr-code').addClass('qrshrink');
        },
        afterLoad: function(anchorLink, index){
            if(index == 1){
                $('#s1pic1').removeClass().addClass('fadeInDown animated inifinite');
                $('p1s2,.p1s3,upArrow,downArrow').removeClass('fadeOut').addClass('fadeIn');
                $('.qr-code').addClass('qrshrink');
            }
            if(index == 2){
        ...
        onLeave: function(index, direction){
            if(index == 1){
                ...
                $('.p1s2,.p1s3,upArrow,downArrow').removeClass('fadeIn').addClass('fadeOut');
            }
            if(index == 2){
                $('.s2block1').hide(0);
