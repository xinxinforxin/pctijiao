$(function(){
        ...
        onLeave: function(index, direction){
            ...
            if(index == 2){
                $('#s2block1').removeClass().addClass('fadeOut animated inifinite');
                $('#s2block2').removeClass().addClass('fadeOut animated inifinite');
                $('#s2block2-1').removeClass().addClass('fadeOutanimated inifinite');
